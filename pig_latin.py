...
def convert(line):
    ...
    for index in range(0, len(words)):
        # get word at index
        # TODO: get the word at index in list words

        word = words[index]

        # translate that word to pig latin
        # TODO: use translate() to translate word to pl_word

        pl_word = translate(word)
...
def find_first_vowel(word):
    ...
    # TODO: Complete this while loop.

    while not is_vowel(current_letter) and index < len(word):

        # TODO: get current letter at index
...
# TODO: Complete the is_vowel function
